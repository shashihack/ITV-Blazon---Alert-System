...
if (isset($_POST['submit'])) {
	...
	$result = mysqli_query($con, "SELECT * FROM student_details WHERE email_id = '" . $email. "' and phone_no = '" .$password. "' and CR_id = '".cr."'");
...
<div style="width:400px; height:450px; border:1px solid white; margin:auto; margin-top:50px; background: url('bck.png'); ">
	...
	<input type="text" name="email" required="required" style=" background: transparent; border:1px solid orange; outline: none; margin-left: 30px; width: 340px; height: 30px; padding: 5px; " >
	...
	<input type="password" name="password" required="" style=" background: transparent; border:1px solid orange; outline: none; margin-left: 30px; width: 340px; height: 30px; padding: 5px; " >
